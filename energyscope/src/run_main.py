...
case_study = 'Scenario_4'  # Give here the name of the case study for
# deterministic run
expl_text = 'comp'  # Give here explanation text to describe the
# case study
...
if __name__ == '__main__':
    ...
    if graph_comp:
        ...
        case_study_1 = 'simulation_clever2'

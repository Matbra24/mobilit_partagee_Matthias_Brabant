...
subject to elec_prod_NUCLEAR_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]}   (   F_t ['YEAR_2025','NUCLEAR', h , td] ) = 32900; #from SPF_Economie, versus 31700 from ELIA, versus 34883 from EU
...
subject to elec_prod_COAL_IGCC_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (   F_t ['YEAR_2025','COAL_IGCC', h , td] ) = 0; #As done by GL for 2015
subject to no_elec_import_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (   F_t ['YEAR_2025','ELECTRICITY', h , td] ) = 0; #from SPF_Economie
...
subject to bioethanol_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIOETHANOL', h , td] ) = 2192.06;# 129.4 ktoe = >
subject to biodiesel_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIODIESEL', h , td] ) = 7110.25;# 355.9 ktoe = >

### No import of electrofuels in 2020
subject to no_H2_RE_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','H2_RE', h , td] ) = 0.0;
subject to no_GAS_RE_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','GAS_RE', h , td] ) = 0.0;
subject to no_AMMONIA_RE_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','AMMONIA_RE', h , td] ) = 0.0;
subject to no_METHANOL_RE_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','METHANOL_RE', h , td] ) = 0.0;

### Production of biomethane
# SOURCE: https://www.cng-mobility.ch/wp-content/uploads/2020/09/EBA-Conference-1-Sept-2020-Dirk-Focroul.pdf
subject to biogas_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIOMETHANATION', h , td] )  = 2500;
...
subject to ned_prod_METHANOL_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','METHANOL', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"METHANOL"]; #Only import of methanol in 2020 to supply methanol
subject to ned_prod_HVC_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','OIL_TO_HVC', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"HVC"]; #Only Naphtha/LPG cracking to supply HVC
subject to ned_prod_AMMONIA_2025: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','HABER_BOSCH', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"AMMONIA"]; #Only Haber-Bosch cracking to supply ammonia
...
fix Share_mobility_public['YEAR_2025']:=0.16;

# MATTHIAS
fix Share_mobility_shared['YEAR_2025']:=0.007;

fix Share_freight_train['YEAR_2025']:=0.112;
fix Share_freight_boat['YEAR_2025']:=0.156;
...
# MATTHIAS
let fmin_perc['YEAR_2025',"CAR_DIESEL_SHARED"] := 0;
let fmin_perc['YEAR_2025',"CAR_GASOLINE_SHARED"] := 0;
let fmin_perc['YEAR_2025',"CAR_HEV_SHARED"] := 0;
let fmin_perc['YEAR_2025',"CAR_NG_SHARED"] := 0;
let fmin_perc['YEAR_2025',"CAR_BEV_SHARED"] := 0;

let fmax_perc['YEAR_2025',"CAR_PHEV_SHARED"] := 0;
let fmax_perc['YEAR_2025',"CAR_FUEL_CELL_SHARED"] := 0;
let fmax_perc['YEAR_2025',"CAR_METHANOL_SHARED"] := 0;
